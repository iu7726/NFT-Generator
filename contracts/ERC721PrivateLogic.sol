...
contract ERC721PrivateLogic is ERC721AUpgradeable, OwnableUpgradeable, IERC721Receiver {
    ...
    function initialize(
        ...
        saleConfig["SALE"] = _info.saleParam;
    ...
    function refund(address to, uint256 tokenId) public {
        uint256 price = saleConfig["SALE"].cost;
        uint256 nowTime = block.timestamp;
        require(nowTime >= timelock - 7 days, "Not Refund Period");
        require(nowTime <= timelock, "Not Refund Period");
